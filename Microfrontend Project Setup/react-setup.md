...
* Install create-react-app with React<br>
```npx create-react-app react-host```<br>
```cd react-host```<br>
```npm install react@16.14.0 react-dom@16.14.0```

* Add Module Federation Plugin<br>
```npm install --save-dev webpack@5 webpack-cli webpack-dev-server html-webpack-plugin babel-loader style-loader css-loader```
```npm uninstall react-scripts```

* Configure Babel (in each project’s root)<br>
{
